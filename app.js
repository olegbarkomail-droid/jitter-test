...
async function startCalibration() {
  ...
  try {
    ...
    // Метроном во время калибровки НЕ запускается автоматически.
    // Пользователь включает его вручную через кнопку «▶ Метроном»,
    // чтобы слышать такт в наушниках и стучать в такт палочкой.
